...
public class VisualizacaoUsuarioPorAdministradorPresenter {
    ...
    public VisualizacaoUsuarioPorAdministradorPresenter(Usuario usuarioLogado, Usuario usuarioSelecionado, 
    ...
    private void configurarView(){
        ...
        view.getBtnExcluir().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e){
                try {
                    new ConfirmacaoExclusaoUsuarioPorAdministradorPresenter(usuarioLogado, usuarioSelecionado, repository);
                } catch (Exception ex){
                    JOptionPane.showMessageDialog(view, "Falha: "+ex.getMessage());
                }
            }
